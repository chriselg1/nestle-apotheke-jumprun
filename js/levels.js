...
const LEVELS = [
  /* ---------- 1 — am See ---------- */
  {
    ...
    solids: [
      ...
      plat(2420, 344, 140), plat(2660, 282, 110),
      plat(3160, 340, 130)
    ],
    ...
    pills: [].concat(
      ...
      pillArc(2180, 396, 5, 46, 96), pills(2690, 236, 3), pills(3200, 294, 3)
    ),
  ...
  /* ---------- 3 — Hofen ---------- */
  {
    ...
    pills: [].concat(
      ...
      pills(3180, 218, 3), pills(3840, 254, 3)
    ),
  ...
  /* ---------- 4 — Linden ---------- */
  {
    ...
    pills: [].concat(
      ...
      pills(2490, 208, 3), pillArc(2620, 396, 4, 44, 96),
