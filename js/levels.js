...
const LEVELS = [
  ...
  /* ---------- 2 — Bodensee ---------- */
  {
    ...
    solids: [
      ...
      plat(1620, 300, 110), plat(1780, 220, 90),
  ...
  /* ---------- 3 — Hofen ---------- */
  {
    ...
    solids: [
      ...
      plat(380, 348, 100), plat(980, 322, 100),
      plat(1300, 280, 100), plat(1420, 190, 90),
      mover(1760, 300, 120, 'y', 140, 58),
      plat(2060, 236, 100), plat(2380, 320, 110), plat(2480, 214, 90),
      mover(2860, 310, 120, 'x', 140, 74),
  ...
  /* ---------- 4 — Linden ---------- */
  {
    ...
    solids: [
      ...
      plat(1240, 268, 100),
      plat(1620, 300, 110), plat(1760, 206, 90),
      mover(2140, 300, 110, 'x', 150, 82),
      plat(2560, 258, 100),
      plat(2900, 320, 110), plat(3040, 226, 90),
      mover(3480, 290, 110, 'y', 150, 66),
      plat(3900, 268, 110), plat(4020, 174, 90),
      plat(4340, 300, 120)
    ],
